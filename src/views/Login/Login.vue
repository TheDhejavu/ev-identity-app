        ...
        <div class="rounded-md shadow-sm -space-y-px">
          <div class="">
            ...
            <input 
              ...
              type="text"
              required
              class="bg-white rounded-t-md appearance-none rounded-none 
              relative block w-full px-4 py-6 border border-gray-200 
          ...
          <div class="">
            ...
            <input 
              ...
              type="password"
              required
              class="bg-white rounded-b-md appearance-none rounded-none 
              relative block w-full px-4 py-6   border border-gray-200 
              placeholder-gray-500 text-gray-900 focus:outline-none 
              focus:ring-green-500 focus:border-green-500 focus:z-10 "
